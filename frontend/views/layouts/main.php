...
<?php $this->beginBody() ?>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="<?= Yii::$app->request->baseUrl;?>/theme/assets/img/Me.jpg" alt="" class="img-fluid rounded-circle">
        <h1 class="text-light"><a href="<?= Url::to(['site/index'])?>">Mohamed Hassan</a></h1>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">Mohamed Hassan</a>
      </div>
    </div>
  </footer><!-- End  Footer -->
